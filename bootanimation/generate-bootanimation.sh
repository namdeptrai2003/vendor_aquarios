...
if [ -f "/usr/bin/convert" ]; then
  if [ -f "$ANDROID_PRODUCT_OUT/system/media/bootanimation.zip" ]; then
    ...
    tar xvfp "$CWD/vendor/aquarios/bootanimation/bootanimation.tar" -C "$ANDROID_PRODUCT_OUT/obj/BOOTANIMATION/bootanimation/$TAR_FILENAME"
    ...
    cat "$CWD/vendor/aquarios/bootanimation/desc.txt" >> "$ANDROID_PRODUCT_OUT/obj/BOOTANIMATION/bootanimation/desc.txt"
